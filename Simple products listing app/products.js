...
const products = [
    {
        ...
        image: "🚀",
        organic: true,
        quantity: "2 per quantity",
        price: 1000.99,
        description: "The space shuttle did many things. It could carry up to seven astronauts at a time. The space shuttle was like a moving van. It took satellites to space so they could orbit Earth. The shuttle carried large parts into space to build the International Space Station.\n" +
            "\n" +
